...
<body>
        ...
        <div class="request__container">
            ...
            <div class="request__search">
                <form class="request__form" action="" method="post">
                    ...
                    <button class="btn btn-default" style="background-color:white;color:black;" name="delete"
    ...
    $sql = "SELECT student.username,student.rollno, books.bid,books.name,books.authors,books.edition,books.status,books.quantity FROM student
    ...
    if (isset($_POST['delete'])) {
      $_SESSION['name'] = $_POST['username'];
      $_SESSION['bid'] = $_POST['bid'];
      $ap = mysqli_query($conn, "DELETE FROM `issue_book` WHERE `username`='$_SESSION[name]' AND `bid`='$_SESSION[bid]';");
    }
    ?>
