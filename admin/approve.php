    ...
    <div id="main">
        ...
        <div class="approve__container">
            ...
            <form class="approve__form" action="" method="post">
                ...
                <input class="form-control" type="text" name="time" placeholder="Return Date   Sep 19, 2021 15:00:00"
                    required><br>
                <button style="background-color:white;color:black;" class="btn btn-default" name="submit"
